...
def efemerides_informatica(pdf, mes):
    ...
    pdf.ln(24)  # Engadir un salto de liña adicional
...
if __name__ == "__main__":
    ...
    pdf.set_margins(0.2 * 10, 0.2 * 10)  # Establecer os marxes laterais a 0,4 cm (multiplicado por 10 para convertelo a puntos)
